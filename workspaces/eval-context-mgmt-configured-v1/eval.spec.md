# eval-context-mgmt-configured-v1 — eval spec

> **Feature spec** for the synthetic workspace at
> [`./`](./).
> **Executable spec:** [`adapter/test/evals/eval-context-mgmt.test.ts`](../../adapter/test/evals/eval-context-mgmt.test.ts).
>
...
- **2026-05-17 (Docker isolation + bare-workspace bracket)** —
  ...
  Then added [`workspaces/eval-context-mgmt-bare-v1/`](../eval-context-mgmt-bare-v1/) —
  ...
  **present**, bare asserts marker **absent**. Six tests total, all
  ...
  2. The Cursor agent did not grep across workspace boundaries
     ...
     `eval-context-mgmt-configured-v1/.cursor/` from the bare workspace and
...
- **Test runner:** [`../../adapter/test/evals/eval-context-mgmt.test.ts`](../../adapter/test/evals/eval-context-mgmt.test.ts)
